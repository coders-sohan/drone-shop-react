										...
										<div className="space-y-1 font-medium">
											...
											>
												...
												{tooltipStatus === 1 && (
													<div
														role="tooltip"
														className="z-20 -mb-20 w-auto absolute transition duration-300 ease-in-out -left-1 shadow-lg p-2 bg-gray-700 border rounded"
													>
											...
											>
												...
												{tooltipStatus2 === 1 && (
													<div
														role="tooltip"
														className="z-20 -mb-20 w-48 absolute transition duration-300 ease-in-out -left-1 shadow-lg p-2 bg-gray-700 border rounded"
													>
