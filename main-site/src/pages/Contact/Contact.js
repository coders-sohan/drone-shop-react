      ...
      <div className="flex justify-between items-center py-12">
        <div className="container mx-auto px-3">
          <div className="lg:flex">
            <div className="xl:w-2/5 lg:w-2/5 bg-red-600 py-16 xl:rounded-bl rounded-tl rounded-tr xl:rounded-tr-none">
            ...
            <div className="xl:w-3/5 lg:w-3/5 bg-red-200 h-full pt-5 pb-5 xl:pr-5 xl:pl-0 rounded-tr rounded-br">
              <form
                id="contact"
                className="bg-white py-4 px-8 rounded-tr rounded-br"
              >
                <h1 className="text-4xl text-red-500 font-extrabold mb-6">
                  Enter Details
                </h1>
                ...
                <div className="w-full mt-6">
                  ...
                  <button
                    type="submit"
                    className="focus:outline-none bg-red-600 transition duration-150 ease-in-out hover:bg-red-700 rounded text-white px-8 py-3 text-sm leading-6"
                  >
                    Submit
                  </button>
                </div>
