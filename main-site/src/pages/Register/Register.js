...
const Register = () => {
	...
	const { user, registerUser, signInWithGoogle, isLoading, error } = useAuth();
			...
			<div className="flex justify-between items-center py-12">
				<div className="container mx-auto px-3">
					<div className="pt-16 lg:w-2/6 md:w-3/4 w-full mx-auto">
						...
						{user?.email && (
							<SuccessAlert user={user} login={false} register={true} />
						)}
						...
						{!isLoading && (
							<div className="mt-5">
								...
								<button
									...
									className="border-red-500 text-red-500 hover:border-red-700 hover:text-red-700 font-semibold rounded-lg text-sm sm:w-auto px-5 py-2.5 text-center transition-all ease-linear flex items-center"
								>
